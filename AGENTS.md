...
[https://docs.browserbase.com/platform/browser/observability](https://docs.browserbase.com/platform/browser/observability)

Session replay specifically — retrieving a session's recording as an HLS playlist — is documented here:

[https://docs.browserbase.com/platform/browser/observability/session-replay](https://docs.browserbase.com/platform/browser/observability/session-replay)
